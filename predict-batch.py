...
model = Pix2Pix({'checkpoint': 'TrainedModels210312_113348_floorplans_tf-2.4.1@last.h5'}).model
# model = Pix2Pix({'checkpoint': None}).model

save_dir = 'C:/Users/ali_n/OneDrive/Desktop/Pix2Pix/Runway/output'

for path in glob.glob('C:/Users/ali_n/Downloads/tmp/*'):
